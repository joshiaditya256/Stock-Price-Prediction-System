# This Python script sets up a web server using Flask to handle requests related to stock price prediction.
# The server includes several endpoints to upload data, start model training, check training status,
# get predictions, and perform manual predictions.
